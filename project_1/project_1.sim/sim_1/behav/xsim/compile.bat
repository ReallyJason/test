...
REM
REM Generated by Vivado on Tue Apr 07 23:41:37 -0400 2026
...
echo "xvlog --incr --relax -prj component_testbench_vlog.prj"
call xvlog  --incr --relax -prj component_testbench_vlog.prj -log xvlog.log
